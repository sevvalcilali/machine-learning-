...
from monitoring.log import log_prediction  # ✅ EKLENDİ
...
def main():
    ...
    df = pd.read_csv(DATA_PATH, compression="gzip", nrows=200)
    ...
    print("Monitoring log yazildi -> data/predictions.csv")  # ✅ EKLENDİ

    # ✅ ORİJİNAL ÇIKTI AYNEN KORUNDU
